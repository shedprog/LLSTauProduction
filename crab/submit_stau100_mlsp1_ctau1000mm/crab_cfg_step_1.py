...
config.General.requestName = 'SUS-RunIISummer20UL18GEN-stau100_lsp1_ctau1000mm_v4'
config.General.workArea = 'crab_projects'

config.section_("JobType")
config.JobType.pluginName = 'PrivateMC'
config.JobType.psetName = '../../python/SUS-RunIISummer20UL18wmLHEGEN-stau100_lsp1_ctau1000mm_cfg.py'
...
config.Data.outputPrimaryDataset = 'SUS-RunIISummer20UL18GEN-stau100_lsp1_ctau1000mm_v4'
