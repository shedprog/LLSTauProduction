...
if [ -r ${ENV_PATH}/CMSSW_10_6_31/src ] ; then
  ...
  #git fetch REMOTE_WITH_FIX from-CMSSW_10_6_31-hard-stau-fix
  #git checkout -b FIXED_BR REMOTE_WITH_FIX/from-CMSSW_10_6_31-hard-stau-fix
...
mkdir -p ${ENV_PATH}/CMSSW_10_6_31/src/data
cp ${OUTDIR}/Configuration/ParticleFiles/*.txt ${ENV_PATH}/CMSSW_10_6_31/src/data

cd ${ENV_PATH}/CMSSW_10_6_31/src

# Step 2: Copy genParticlePlusGeant
#cp -f ${OUTDIR}/Configuration/genParticlePlusGeant.py ${ENV_PATH}/CMSSW_10_6_31/src/SimG4Core/CustomPhysics/python/genParticlePlusGeant.py

# Step 3: Copy HSCP file
#cp -f ${OUTDIR}/Configuration/Exotica_HSCP_SIM_cfi.py ${ENV_PATH}/CMSSW_10_6_31/src/SimG4Core/CustomPhysics/python/Exotica_HSCP_SIM_cfi.py

# Step 3: Copy fragment-file
source ${ABS_PATH}/CrossSection.sh
mkdir -p ${ENV_PATH}/CMSSW_10_6_31/src/Configuration/GenProduction/python
