...
process.configurationMetadata = cms.untracked.PSet(
    annotation = cms.untracked.string('Configuration/GenProduction/python/SUS-RunIISummer20UL18wmLHEGEN-fragment-stau400_lsp1_ctau100mm.py nevts:20'),
...
process.generator = cms.EDFilter("Pythia8GeneratorFilter",
    ...
    particleFile = cms.untracked.string('data/particles_stau_mstau400GeV_mlsp1GeV_ctau100mm.txt'),
