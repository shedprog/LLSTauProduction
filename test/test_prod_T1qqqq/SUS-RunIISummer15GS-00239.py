...
generator = cms.EDFilter("Pythia8GeneratorFilter",
    ...
    massPoint = cms.untracked.int32(int(mLSP)),
    slhaFile  = cms.string('dummy.slha'), 
    particleFile = cms.untracked.string('Configuration/Generator/data/SUSY/LLTChipm/pointcharginodecay_mLSP-%i_ctau-%s.txt' % (mLSP, ctau)),  
)
