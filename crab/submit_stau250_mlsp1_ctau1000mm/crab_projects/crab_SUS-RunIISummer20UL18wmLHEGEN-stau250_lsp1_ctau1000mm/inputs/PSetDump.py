...
process.RAWSIMEventContent = cms.PSet(
    ...
    outputCommands = cms.untracked.vstring(
        ...
        'keep *_genParticlePlusGeant_*_*', 
        'keep *_packedGenParticlePlusGeant_*_*', 
        'keep *_prunedGenParticlePlusGeant_*_*'
    ),
    splitLevel = cms.untracked.int32(0)
)
...
process.customPhysicsSetup = cms.PSet(
    ...
    hadronLifeTime = cms.double(-1.0),
    mixing = cms.double(1.0),
    particlesDef = cms.FileInPath('data/particles_stau_mstau250GeV_mlsp1GeV_ctau1000mm.txt'),
...
process.g4SimHits = cms.EDProducer("OscarMTProducer",
    ...
    Watchers = cms.VPSet(cms.PSet(
        RHStopTracer = cms.PSet(
            ...
            traceParticle = cms.string('((anti_)?~|tau1).*'),
...
process.simulation_step = cms.Path(process.ProductionFilterSequence+process.psim+process.genParticlePlusGeant)
