...
cp /afs/cern.ch/user/m/myshched/STauGENProduction/test_prod_stausetup_chargino/SUS-RunIIFall18GS-00022-fragment.py Configuration/GenProduction/python/SUS-RunIIFall18GS-00022-fragment.py

cp /afs/cern.ch/user/m/myshched/STauGENProduction/test_prod_stausetup_chargino/pointcharginodecay_mLSP-400_ctau-200cm.txt ./
...
# cmsDriver command
# cmsDriver.py Configuration/GenProduction/python/SUS-RunIIFall18GS-00022-fragment.py --python_filename SUS-RunIIFall18GS-00022_1_cfg.py --eventcontent RAWSIM --outputCommand 'keep *_genParticlePlusGeant_*_*' --customise SLHCUpgradeSimulations/Configuration/postLS1Customs.customisePostLS1,SimG4Core/CustomPhysics/GenPlusSimParticles_cfi.customizeProduce,SimG4Core/CustomPhysics/GenPlusSimParticles_cfi.customizeKeep,SimG4Core/CustomPhysics/Exotica_HSCP_SIM_cfi,Configuration/DataProcessing/Utils.addMonitoring --datatier GEN-SIM --fileout file:SUS-RunIIFall18GS-00022.root --conditions 102X_upgrade2018_realistic_v11 --beamspot Realistic25ns13TeVEarly2018Collision --customise_commands "process.source.numberEventsInLuminosityBlock = cms.untracked.uint32(200)"\\nprocess.source.numberEventsInLuminosityBlock="cms.untracked.uint32(191)" --step GEN,SIM --geometry DB:Extended --era Run2_2018 --no_exec --mc -n $EVENTS || exit $? ;

# --customise SimG4Core/CustomPhysics/Exotica_HSCP_SIM_cfi.customise

cmsDriver.py Configuration/GenProduction/python/SUS-RunIIFall18GS-00022-fragment.py --python_filename SUS-RunIIFall18GS-00022_1_cfg.py --eventcontent RAWSIM --outputCommand 'keep *_genParticlePlusGeant_*_*' --customise SimG4Core/CustomPhysics/GenPlusSimParticles_cfi.customizeProduce,SimG4Core/CustomPhysics/GenPlusSimParticles_cfi.customizeKeep,SimG4Core/CustomPhysics/Exotica_HSCP_SIM_cfi,Configuration/DataProcessing/Utils.addMonitoring --datatier GEN-SIM --fileout file:SUS-RunIIFall18GS-00022.root --conditions 102X_upgrade2018_realistic_v11 --beamspot Realistic25ns13TeVEarly2018Collision --customise_commands "process.source.numberEventsInLuminosityBlock = cms.untracked.uint32(200)"\\nprocess.source.numberEventsInLuminosityBlock="cms.untracked.uint32(191)" --step GEN,SIM --geometry DB:Extended --era Run2_2018 --no_exec --mc -n $EVENTS || exit $? ;
