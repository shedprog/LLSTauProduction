...
echo "Creating cmsDrive for PREMIXRAW"
cmsDriver.py  --python_filename ${OUTDIR}/python/SUS-RunIIAutumn18DRPremix-00225_1_cfg.py --eventcontent PREMIXRAW --outputCommand 'keep *_genParticlePlusGeant_*_*' --customise SimG4Core/CustomPhysics/GenPlusSimParticles_cfi.customizeProduce,SimG4Core/CustomPhysics/GenPlusSimParticles_cfi.customizeKeep,Configuration/DataProcessing/Utils.addMonitoring --datatier GEN-SIM-RAW --fileout file:SUS-RunIIAutumn18DRPremix-00225_0.root --pileup_input "dbs:/Neutrino_E-10_gun/RunIISummer17PrePremix-PUAutumn18_102X_upgrade2018_realistic_v15-v1/GEN-SIM-DIGI-RAW" --conditions 102X_upgrade2018_realistic_v15 --step DIGI,DATAMIX,L1,DIGI2RAW,HLT:@relval2018 --procModifiers premix_stage2 --geometry DB:Extended --filein file:SUS-RunIIFall18GS-00022.root --datamix PreMix --era Run2_2018 --no_exec --mc  -n 100 || exit $? ;

echo "Creating cmsDrive for AODSIM"
cmsDriver.py  --python_filename ${OUTDIR}/python/SUS-RunIIAutumn18DRPremix-00225_2_cfg.py --eventcontent AODSIM --outputCommand 'keep *_genParticlePlusGeant_*_*' --customise SimG4Core/CustomPhysics/GenPlusSimParticles_cfi.customizeProduce,SimG4Core/CustomPhysics/GenPlusSimParticles_cfi.customizeKeep,Configuration/DataProcessing/Utils.addMonitoring --datatier AODSIM --fileout file:SUS-RunIIAutumn18DRPremix-00225.root --conditions 102X_upgrade2018_realistic_v15 --step RAW2DIGI,L1Reco,RECO,RECOSIM,EI --procModifiers premix_stage2 --filein file:SUS-RunIIAutumn18DRPremix-00225_0.root --era Run2_2018 --runUnscheduled --no_exec --mc  -n 100 || exit $? ;

echo "Creating cmsDrive for MINIAODSIM"
cmsDriver.py  --python_filename ${OUTDIR}/python/SUS-RunIIAutumn18MiniAOD-00351_1_cfg.py --eventcontent MINIAODSIM --outputCommand 'keep *_genParticlePlusGeant_*_*' --customise SimG4Core/CustomPhysics/GenPlusSimParticles_cfi.customizeProduce,SimG4Core/CustomPhysics/GenPlusSimParticles_cfi.customizeKeep,Configuration/DataProcessing/Utils.addMonitoring --datatier MINIAODSIM --fileout file:SUS-RunIIAutumn18MiniAOD-00351.root --conditions 102X_upgrade2018_realistic_v15 --step PAT --geometry DB:Extended --filein file:SUS-RunIIAutumn18DRPremix-00225.root --era Run2_2018 --runUnscheduled --no_exec --mc  -n 100 || exit $? ;

# eval `scram runtime -sh`

# # Combine 3 steps into one
# cmsDriver.py  --python_filename ${OUTDIR}/python/SUS-RunIIFall18GS_updated_step2.py --eventcontent AODSIM --outputCommand 'keep *_genParticlePlusGeant_*_*' --customise SimG4Core/CustomPhysics/GenPlusSimParticles_cfi.customizeProduce,SimG4Core/CustomPhysics/GenPlusSimParticles_cfi.customizeKeep,Configuration/DataProcessing/Utils.addMonitoring --datatier AODSIM --fileout file:SUS-RunIIAutumn18DRPremix-00225.root --pileup_input "dbs:/Neutrino_E-10_gun/RunIISummer17PrePremix-PUAutumn18_102X_upgrade2018_realistic_v15-v1/GEN-SIM-DIGI-RAW" --conditions 102X_upgrade2018_realistic_v15 --step DIGI,DATAMIX,L1,DIGI2RAW,HLT:@relval2018,RAW2DIGI,L1Reco,RECO,RECOSIM,EI --procModifiers premix_stage2 --geometry DB:Extended --filein file:SUS-RunIIFall18GS-00022.root --datamix PreMix --era Run2_2018 --no_exec --mc || exit $? ;
