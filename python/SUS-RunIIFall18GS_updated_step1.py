...
# with command line options: Configuration/GenProduction/python/SUS-RunIIFall18GS-00022-fragment.py --python_filename /afs/cern.ch/user/m/myshched/STauGENProduction/LLSTauProduction/script/../python/SUS-RunIIFall18GS_updated_step1.py --eventcontent RAWSIM --outputCommand keep *_genParticlePlusGeant_*_* --customise SimG4Core/CustomPhysics/GenPlusSimParticles_cfi.customizeProduce,SimG4Core/CustomPhysics/GenPlusSimParticles_cfi.customizeKeep,SimG4Core/CustomPhysics/Exotica_HSCP_SIM_cfi,Configuration/DataProcessing/Utils.addMonitoring --datatier GEN-SIM --fileout file:SUS-RunIIFall18GS-00022.root --conditions 102X_upgrade2018_realistic_v11 --beamspot Realistic25ns13TeVEarly2018Collision --customise_commands process.source.numberEventsInLuminosityBlock = cms.untracked.uint32(200)\nprocess.source.numberEventsInLuminosityBlock=cms.untracked.uint32(191) --step GEN,SIM --geometry DB:Extended --era Run2_2018 --no_exec --mc
...
process.generator = cms.EDFilter("Pythia8GeneratorFilter",
    ...
    particleFile = cms.untracked.string('particles_stau_mstau100GeV_mlsp1GeV_ctau1000mm.txt'),
