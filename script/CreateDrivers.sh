...
cmsDriver.py Configuration/GenProduction/python/SUS-RunIIFall18GS-00022-fragment.py --python_filename ${OUTDIR}/python/SUS-RunIIFall18GS_updated_step1.py --eventcontent RAWSIM --outputCommand 'keep *_genParticlePlusGeant_*_*' --customise SimG4Core/CustomPhysics/GenPlusSimParticles_cfi.customizeProduce,SimG4Core/CustomPhysics/GenPlusSimParticles_cfi.customizeKeep,SimG4Core/CustomPhysics/Exotica_HSCP_SIM_cfi,Configuration/DataProcessing/Utils.addMonitoring --datatier GEN-SIM --fileout file:SUS-RunIIFall18GS-00022.root --conditions 102X_upgrade2018_realistic_v11 --beamspot Realistic25ns13TeVEarly2018Collision --customise_commands "process.source.numberEventsInLuminosityBlock = cms.untracked.uint32(200)"\\nprocess.source.numberEventsInLuminosityBlock="cms.untracked.uint32(191)" --step GEN,SIM --geometry DB:Extended --era Run2_2018 --no_exec --mc -n 100 || exit $? ;
...
cmsDriver.py  --python_filename ${OUTDIR}/python/SUS-RunIIFall18GS_updated_step2.py --eventcontent MINIAODSIM --outputCommand 'keep *_genParticlePlusGeant_*_*' --customise SimG4Core/CustomPhysics/GenPlusSimParticles_cfi.customizeProduce,SimG4Core/CustomPhysics/GenPlusSimParticles_cfi.customizeKeep,Configuration/DataProcessing/Utils.addMonitoring --datatier MINIAODSIM --fileout file:SUS-RunIIAutumn18MiniAOD-00351.root --pileup_input "dbs:/Neutrino_E-10_gun/RunIISummer17PrePremix-PUAutumn18_102X_upgrade2018_realistic_v15-v1/GEN-SIM-DIGI-RAW" --conditions 102X_upgrade2018_realistic_v15 --step DIGI,DATAMIX,L1,DIGI2RAW,HLT:@relval2018,RAW2DIGI,L1Reco,RECO,RECOSIM,EI,PAT --procModifiers premix_stage2 --geometry DB:Extended --filein file:SUS-RunIIFall18GS-00022.root --datamix PreMix --era Run2_2018 --runUnscheduled --no_exec --mc || exit $? ;
