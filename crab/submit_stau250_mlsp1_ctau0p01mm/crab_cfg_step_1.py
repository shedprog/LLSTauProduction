...
config.General.requestName = 'SUS-RunIISummer20UL18GEN-stau250_lsp1_ctau0p01mm_v6'
config.General.workArea = 'crab_projects'

config.section_("JobType")
config.JobType.pluginName = 'PrivateMC'
config.JobType.psetName = '../../python/SUS-RunIISummer20UL18wmLHEGEN-stau250_lsp1_ctau0p01mm_cfg.py'
...
config.Data.outputPrimaryDataset = 'SUS-RunIISummer20UL18GEN-stau250_lsp1_ctau0p01mm_v6'
